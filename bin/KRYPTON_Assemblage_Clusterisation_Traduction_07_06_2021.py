...
if mode_pipeline == "assembly" or mode_pipeline == "reads" :
        ...
        os.system("python {}/modifi_format.py clusterRes_rep_seq.fasta.transdecoder.pep > clusterpep.fasta 2>&1".format(directory_KRIPTON))
...
if mode_pipeline == "cds" :
        ...
        os.system("python {}/modifi_format.py assembly.fasta.transdecoder.pep > clusterpep.fasta 2>&1".format(directory_KRIPTON))
